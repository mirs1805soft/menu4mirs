...
def scdl_mon_finish():
    scdl_mon2_btn1.destroy()
    scdl_mon2_btn2.destroy()
    scdl_mon2_btn3.destroy()
...
def scdl_day2():
    scdl_month2_etr.destroy()
    scdl_month2_btn.destroy()
